...
TARGET_DIR = os.path.abspath(os.path.join(BASE_DIR, os.pardir, "data", "PHOENIX-Weather-2014T-compressed"))

print("="*80)
print("PHOENIX-Weather-2014T-compressed Dataset Download from Kaggle")
print("="*80)
print()
...
try:
    print("Downloading PHOENIX-Weather-2014T-compressed dataset from Kaggle...")
    print("Dataset: mariusschmidtmengin/phoenixweather2014t-3rd-attempt")
    print()
    ...
    download_path = kagglehub.dataset_download("mariusschmidtmengin/phoenixweather2014t-3rd-attempt")
